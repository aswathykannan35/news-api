const headlineBtn = document.getElementById("headlines");
...
// apis 
const API_KEY = "dddc75b7e2464881b52bcc48a8be0bec";
...
function displayNews() {
    ...
    newsDataArr.forEach(news => {
        ...
        col.className="col-sm-12 col-md-4 col-lg-3 p-2 m-0.5 card";
